<div class="ctheme-business">
    <h3 class="text-center py-3 text-uppercase"><?php echo 'Car & Tech' ?></h3>
    <div class="row business-container">
        <div class="col-lg-8 col-12 mb-5">
            ...
            <a href="/category/car" class="ctheme-more-articles more-articles">More Articles</a>
        </div>
        <div class="col-lg-4 col-12 mb-5">
            <?php dynamic_sidebar('car-banner'); ?>
        </div>
    </div>
</div>