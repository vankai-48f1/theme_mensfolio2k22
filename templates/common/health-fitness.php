<div class="ctheme-helth-fitness">
    <h3 class="text-center py-3 text-uppercase"><?php echo get_cat_name(18); ?></h3>
    <div class="row health-fitness-container">
        <div class="row">
            <!-- card -->
            <?php
            $cat_id = 18; //Health & Fitness
        ...
        <a href="/category/health-fitness" class="ctheme-more-articles more-articles">More Articles</a>
    </div>
</div>