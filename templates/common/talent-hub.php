    ...
    <div class="pb-5">
        ...
        <div class="row talent-hub-container">
            <div class="col-lg-12">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="text-center py-3 px-3">
                                        <a href="<?php echo get_permalink($id); ?>" title="<?php echo $post_title; ?>" alt="<?php echo $post_title; ?>">
                                            <h5 class="card-title font-family-01"><?php echo wp_trim_words(get_the_title(), 4668); ?></h5>
                                        </a>
                ...
                <a href="/category/talent-hub" class="ctheme-more-articles more-articles">More Articles</a>
            </div>
        </div>
    </div>
    <hr>
