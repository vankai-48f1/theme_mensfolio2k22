<div class="mb-5">
    <h3 class="text-center py-3 text-uppercase"><?php echo get_cat_name(20); ?></h3>
    <div class="row lifestyle-container">
        <div class="col-lg-12">
            ...
            <a href="/category/lifestyle" class="ctheme-more-articles more-articles">More Articles</a>
        </div>
    </div>
</div>
<hr>